...
//
//			if(flag){
//				 doc.addField("latlong", commercial.getLatlong());
//			}
//
//  	        docs.add(doc);
//
...
//     * @return 商户ID集合
//     */
//    public ShopInfoVOLbs query(Double longitude,Double latitude,Double distance,Integer start,Integer count){
...
//
//    	ShopInfoVOLbs lbs = new ShopInfoVOLbs();
//    	List<SimpleCommercial> simpleCommercials = new ArrayList<SimpleCommercial>();
//    	client.connect();
//    	try {
//			 QueryResponse response = client.query(query);
//			 //搜索得到的结果数
//			 Long countAll = response.getResults().getNumFound();
//	         lbs.setCount(countAll);
...
//				 SimpleCommercial simple = new SimpleCommercial(commercialId,commercial_distance);
//				 simpleCommercials.add(simple);
//	         }
//			 lbs.setSimpleCommercials(simpleCommercials);
//    	} catch (SolrServerException e) {
//			e.printStackTrace();
//    	} catch (Exception e) {
//			e.printStackTrace();
